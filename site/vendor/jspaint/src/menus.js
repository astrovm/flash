...
const menus = {
	[localize("&File")]: [
		...
		MENU_DIVIDER,
		{
			label: `${localize("From Scanner or Camera")}...`,
			enabled: false,
			description: localize("Gets a picture from a scanner or digital camera."),
		},
		MENU_DIVIDER,
		{
		...
		MENU_DIVIDER,
		{
			label: `${localize("Sen&d")}...`,
			enabled: false,
			description: localize("Sends this picture in an e-mail message."),
		},
		MENU_DIVIDER,
		{
			label: localize("Set As &Background (Tiled)"),
			speech_recognition: [
				"set as wallpaper",
		...
		{
			label: localize("Set As Background (&Centered)"),
			speech_recognition: [
