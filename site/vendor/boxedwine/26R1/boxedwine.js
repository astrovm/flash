...
var ASM_CONSTS = {
  324404: () => {  },
 324405: ($0) => { console.log("BOXEDWINE_FILE:" + UTF8ToString($0)); window.parent.postMessage({ type: "boxedwine-file-read", path: UTF8ToString($0) }, window.location.origin); },
 324568: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },
 324783: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },
 324930: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },
 ...
 333206: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },
 333289: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },
 333358: () => { return window.innerWidth; },
 333388: () => { return window.innerHeight; },
 333419: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }
};
