...
const sourcePath = join(runtimeRoot, "boxedwine.zip");
const tracePath = join(runtimeRoot, "xp-accessories-files.json");
const outputPath = join(runtimeRoot, "xp-accessories.zip");
